# Api.Logging.Microsoft

> _Nano API application with Microsoft logging._  
...
This application demonstrates logging with Microsoft for a API application. Also note the `LogLevelOverrides` configuration, 
...
> 📖 Learn more about **[Nano.Logging.Microsoft](https://github.com/Nano-Core/Nano.Library/tree/master/Nano.Logging.Microsoft/README.md#nanologgingmicrosoft)**.
