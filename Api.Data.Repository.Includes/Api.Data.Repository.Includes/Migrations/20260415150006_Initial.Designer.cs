...
namespace Api.Data.Repository.Includes.Migrations
{
    ...
    [Migration("20260415150006_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Data.Repository.Includes.Models.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("ProfileId")
                        .IsUnique()
                        .HasDatabaseName("UX_Customer_ProfileId");

                    b.ToTable("Customer");
                });

            modelBuilder.Entity("Api.Data.Repository.Includes.Models.CustomerProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Api.Data.Repository.Includes.Models.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Api.Data.Repository.Includes.Models.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Api.Data.Repository.Includes.Models.Customer", b =>
                {
                    b.HasOne("Api.Data.Repository.Includes.Models.CustomerProfile", "Profile")
                        .WithOne("Customer")
                        .HasForeignKey("Api.Data.Repository.Includes.Models.Customer", "ProfileId")
            ...
            modelBuilder.Entity("Api.Data.Repository.Includes.Models.Order", b =>
                {
                    b.HasOne("Api.Data.Repository.Includes.Models.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Api.Data.Repository.Includes.Models.Payment", "Payment")
                        .WithOne("Order")
                        .HasForeignKey("Api.Data.Repository.Includes.Models.Order", "PaymentId");
