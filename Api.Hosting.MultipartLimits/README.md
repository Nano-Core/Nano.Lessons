...
> _Nano API application with upload limits._  
...
> 📖 Learn more about **[Nano MultiPart Limits](https://github.com/Nano-Core/Nano.Library/blob/master/Nano.App.Api/README.md#multipart-limits)**.
