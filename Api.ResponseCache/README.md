...
This example demonstrates using response caching with a Nano application.  
...
> 📖 Learn more about **[Nano Response Cache](https://github.com/Nano-Core/Nano.Library/blob/master/Nano.App.Api/README.md#response-cache)**.
