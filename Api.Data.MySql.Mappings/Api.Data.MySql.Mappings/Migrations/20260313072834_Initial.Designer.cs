...
namespace Api.Data.MySql.Mappings.Migrations
{
    ...
    [Migration("20260313072834_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Data.MySql.Mappings.Models.ExampleJson", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("ProfileAsJson")
                    ...
                    b.ToTable("ExampleJson");
                });

            modelBuilder.Entity("Api.Data.MySql.Mappings.Models.ExampleNormalized", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("FullNameNormalized", "IsDeleted")
                        .IsUnique()
                        .HasDatabaseName("UX_ExampleNormalized_FullNameNormalized_IsDeleted");

                    b.ToTable("ExampleNormalized");
                });

            modelBuilder.Entity("Api.Data.MySql.Mappings.Models.ExampleOwned", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Api.Data.MySql.Mappings.Models.ExampleOwned", b =>
                {
                    b.OwnsOne("Api.Data.MySql.Mappings.Models.Types.Profile", "Profile", b1 =>
                        {
                            b1.Property<Guid>("ExampleOwnedId")
                                .HasColumnType("char(36)");

                            b1.Property<string>("Text")
                                .HasColumnType("longtext");

                            b1.HasKey("ExampleOwnedId");

                            b1.ToTable("ExampleOwned");

                            b1.WithOwner()
                                .HasForeignKey("ExampleOwnedId");

                            b1.OwnsOne("Api.Data.MySql.Mappings.Models.Types.ProfilePicture", "Picture", b2 =>
                                {
                                    b2.Property<Guid>("ProfileExampleOwnedId")
                                        .HasColumnType("char(36)");
                                    ...
                                    b2.HasKey("ProfileExampleOwnedId");

                                    b2.ToTable("ExampleOwned");

                                    b2.WithOwner()
                                        .HasForeignKey("ProfileExampleOwnedId");
                                });

                            b1.OwnsOne("Api.Data.MySql.Mappings.Models.Types.ProfileSettings", "Settings", b2 =>
                                {
                                    b2.Property<Guid>("ProfileExampleOwnedId")
                                        .HasColumnType("char(36)");

                                    b2.Property<bool>("HideProfileName")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("tinyint(1)")
                                        .HasDefaultValue(false);

                                    b2.Property<bool>("UseDarkMode")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("tinyint(1)")
                                        .HasDefaultValue(false);
