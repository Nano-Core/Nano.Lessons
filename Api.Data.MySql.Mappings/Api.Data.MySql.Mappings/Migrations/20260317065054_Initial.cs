...
namespace Api.Data.MySql.Mappings.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ProfileAsJson = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExampleJson", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");

            migrationBuilder.CreateTable(
                name: "ExampleNormalized",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExampleNormalized", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    Profile_Text = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Profile_Picture_Id = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    Profile_Picture_Path = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Profile_Settings_UseDarkMode = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    Profile_Settings_HideProfileName = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    IsDeleted = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExampleOwned", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyName = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RelationName = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExampleJson_CreatedAt",
                table: "ExampleJson",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_ExampleJson_IsDeleted",
                table: "ExampleJson",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ExampleNormalized_CreatedAt",
                table: "ExampleNormalized",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_ExampleNormalized_IsDeleted",
                table: "ExampleNormalized",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "UX_ExampleNormalized_FullNameNormalized",
                table: "ExampleNormalized",
                column: "FullNameNormalized",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExampleOwned_CreatedAt",
                table: "ExampleOwned",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_ExampleOwned_IsDeleted",
                table: "ExampleOwned",
                column: "IsDeleted");
        }
