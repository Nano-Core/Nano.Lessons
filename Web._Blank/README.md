...
## Summary
This application represents the most minimal (blank) Nano Web application setup. 

Its purpose is to demonstrate the required boilerplate, file structure, and general configuration needed to create a Nano Web application. 
