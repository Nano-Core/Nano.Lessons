...
> _Nano API application with response compression._  
...
> 📖 Learn more about **[Nano Response Compression](https://github.com/Nano-Core/Nano.Library/blob/master/Nano.App.Api/README.md#response-compression)**.
