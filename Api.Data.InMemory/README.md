...
and the [Data Context](https://github.com/Nano-Core/Nano.Library/blob/master/Nano.Data/README.md#data-context). As the in-memory data provider doesn't use migrations there is no need 
...
> 📖 Learn more about **[Nano.Data.InMemory](https://github.com/Nano-Core/Nano.Library/blob/master/Nano.Data.InMemory/README.md#nanodatainmemory)**.
