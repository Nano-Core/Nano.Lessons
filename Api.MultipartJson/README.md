...
> _Nano API application using request multipart json._  
...
> 📖 Learn more about **[Nano Request Multipart JSON](https://github.com/Nano-Core/Nano.Library/blob/master/Nano.App.Api/README.md#request-multipart-json)**.
